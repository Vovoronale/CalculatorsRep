...
```text
Розрахунок вертикального навантаження з урахуванням власної ваги фундаменту і ґрунту на обрізах (Методика визначення крайових напружень під прямокутною підошвою фундаменту; назву джерела буде уточнено користувачем):
```
...
```text
Геометричні характеристики підошви (Методика визначення крайових напружень під прямокутною підошвою фундаменту; назву джерела буде уточнено користувачем):
```
...
```text
Зовнішні зусилля на рівні підошви (Методика визначення крайових напружень під прямокутною підошвою фундаменту; назву джерела буде уточнено користувачем):
```
...
```text
Напруження по кутах підошви, обчислені без урахування відриву (Методика визначення крайових напружень під прямокутною підошвою фундаменту; назву джерела буде уточнено користувачем):
```
...
```text
Контактна епюра з урахуванням відриву (Методика визначення крайових напружень під прямокутною підошвою фундаменту; назву джерела буде уточнено користувачем):
```
...
```text
Відрив підошви в одному куті (Методика визначення крайових напружень під прямокутною підошвою фундаменту; назву джерела буде уточнено користувачем):
```
...
```text
Відрив підошви у двох кутах (Методика визначення крайових напружень під прямокутною підошвою фундаменту; назву джерела буде уточнено користувачем):
```
...
```text
Перевірка рівноваги контактної епюри з урахуванням відриву (Методика визначення крайових напружень під прямокутною підошвою фундаменту; назву джерела буде уточнено користувачем):
```
