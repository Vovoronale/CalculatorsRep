...
- Do not render descriptive paragraphs for these items in the page references zone.
- Each item renders a collapsible block with summary text `Скан фрагмента ДБН` and the matching image.
